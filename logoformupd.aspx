<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="logoformupd.aspx.cs" Inherits="logoformupd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <div class="container1">
    ...
    <div class="right">
        ...
        <br />
        <asp:TextBox ID="TextBox4" runat="server" Width="573px" BorderColor="White" 
            Height="36px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
            ControlToValidate="TextBox4" 
            ErrorMessage="please enter id number which you want to update" ForeColor="Red">*</asp:RequiredFieldValidator>
        <br />
        <br />
