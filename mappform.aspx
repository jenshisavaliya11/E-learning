<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="mappform.aspx.cs" Inherits="mappform" %>
...
&nbsp;<br />Password:<br />
        ...
        <asp:GridView ID="GridView2" runat="server" BackColor="#003366" 
            BorderStyle="Double" ForeColor="White" Height="170px" Width="750px" 
