<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="logoformadd.aspx.cs" Inherits="logoformadd" %>
...
&nbsp;<br />Password:<br />
        ...
        <asp:Button ID="Button1" runat="server" BackColor="#003366" BorderStyle="Solid" 
            ForeColor="White" Height="47px"  Text="add" 
