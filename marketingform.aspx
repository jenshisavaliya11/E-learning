<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="marketingform.aspx.cs" Inherits="marketingform" %>
...
&nbsp;<br />Password:<br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [id], [fnm], [email], [phno], [gen], [course], [time] FROM [marketingform1]">
        </asp:SqlDataSource>
        <br />
        <br />
        <br />
