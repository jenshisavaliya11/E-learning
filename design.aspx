...
<link href="css/design.css?v=1.1" rel="stylesheet" />
</asp:Content>
...
<div class="a4courses">
  <div class="a4course-card">
   <a href="graphicdesign.aspx"> <asp:Image ID="imgCourse1" runat="server" CssClass="a4course-image"
      ImageUrl="~/projectimg/gd.jpeg" 
...
" />
  ...
  <div class="a4course-card">
   <a href="brand_identity.aspx"> <asp:Image ID="imgCourse2" runat="server" CssClass="a4course-image"
      ImageUrl="~/projectimg/Brand-Identity-Image.png" 
      AlternateText="Brand & Identity Design" /></a>
    <div class="a4course-info">
      <div class="a4course-title"><asp:Literal ID="litCourse2Title" runat="server" Text="Brand & Identity Design" /></div>
      <div class="a4course-desc">
        <asp:Literal ID="litCourse2Desc" runat="server" Text="This course guides you through the process of creating, developing, and managing a compelling brand that resonates with your target audience.Learn how to craft a unique brand personality, design visual elements.
" />
      </div>
      <div class="a4author">
